...
export default function Home() {
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="w-full h-auto sm:h-[814px] py-8 sm:py-0 px-4 sm:px-0 flex flex-col sm:flex-row items-center justify-center gap-8 sm:gap-[60px]">
        <div className="w-full max-w-[1320px] flex flex-col sm:flex-row items-center justify-center gap-8 sm:gap-[60px]">
          {/* 텍스트 영역 */}
          <div className="w-full sm:w-[854px] order-1 sm:order-2">
            <div className="flex flex-col gap-8 sm:gap-[120px]">
              {/* SectionHeader */}
              ...
              {/* 통계 */}
              <div className="grid grid-cols-2 sm:flex sm:flex-row gap-6 sm:gap-[40px]">
                <div className="text-center sm:text-left">
          ...
          {/* 이미지 박스 */}
          <div className="w-full max-w-[300px] sm:w-[460px] h-[250px] sm:h-[622px] order-2 sm:order-1">
            <div className="w-full h-full rounded-xl bg-[#D9D9D9] flex items-center justify-center">
              <img
